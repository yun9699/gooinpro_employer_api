class JobPostingRegisterDTO {
    ...
    constructor(eno, jpname, jpcontent, jpvacancies, jphourlyRate, jpworkDays, jpminDuration, jpmaxDuration, jpworkStartTime, jpworkEndTime, wroadAddress, wdetailAddress) {
        this.eno = eno;                         // 고용인 ID
